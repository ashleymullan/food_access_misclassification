  ...
  for (ppv in c(0.5, 0.6, 0.8, 0.9)){
    ...
    for (r in 1:num_reps) {
      ...
      write.csv(x = sett_res,
                file = paste0("vary_ppv/proximity_N", N, "_ppv", 100 * ppv, "_seed", sim_seed, ".csv"), 
                row.names = F)
    }
  }
...
# Timing from tictoc:
# Sims with N = 390: 179.397 sec elapsed
# Sims with N = 2200: Sims with N = 2200: 665.759 sec elapsed
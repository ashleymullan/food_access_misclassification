...
url_stem = "~/Documents/food_access_misclassification/Simulations/diff_errors/"
...
res |> 
  ...
  dplyr::summarize(avg_fpr = mean(fpr), 
                   ...
                   avg_ppv_smle = mean(ppv_smle)
                   ) |> 
  write.csv("~/Documents/food_access_misclassification/Simulations/sims_diff_errors_binX_summary.csv", 
            row.names = FALSE)
...
est_box = res |> 
  ...
  dplyr::select(-dplyr::starts_with("se_"), 
                ...
                -ppv_smle) |> 
  tidyr::gather(key = "Method", value = "est_beta1", -c(1:7)) |> 
...
# Save it 
ggsave(filename = "~/Documents/food_access_misclassification/Figures/sim_box_pr_diff_N390.png",
       plot = est_box, 
       device = "png", 
       width = 10, 
       height = 5)
...
# Save it 
ggsave(filename = "~/Documents/food_access_misclassification/Figures/sim_box_pr_diff_N2200.png",
       plot = est_box, 
       device = "png", 
       width = 10, 
       height = 5)
